...
import NewsDeskStackNavigation from '../Navigations/NewsDeskStackNavigation';
import MostViewedArticle from '../Components/MostViewedArticle';
   ...
   return (
      <StickyParallaxHeader
         ...
         tabs={[
            ...
            {
               content: <NewsDeskStackNavigation />,
               title: 'NewsDeskCategory',
            },
            {
               content: <MostViewedArticle />,
               title: 'MVA',
            },
         ]}
      />
